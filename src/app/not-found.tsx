          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <h3 className="mb-4 text-3xl font-bold text-base-content sm:text-4xl">
                ...
                <Link
                  href="/"
                  className="px-8 py-3 text-base font-bold text-base-content duration-300 rounded-md bg-accent shadow-signUp hover:bg-accent-content hover:text-accent md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>

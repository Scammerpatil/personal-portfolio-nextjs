const SharePost = ({ slug }: { slug: string }) => {
  return (
    <>
      <a
        href={`https://www.linkedin.com/sharing/share-offsite/?url=${process.env.DOMIAN}/blog/[${slug}]`}
      ...
      <a
        href={`https://twitter.com/intent/tweet?text=Check%20out%20this%20blog%21&url=${process.env.DOMIAN}/blog/[${slug}]`}
        aria-label="social-share"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href={`https://www.facebook.com/sharer/sharer.php?u=${process.env.DOMIAN}/blog/[${slug}]`}
        aria-label="social-share"
        target="_blank"
        rel="noopener noreferrer"
        className="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary"
